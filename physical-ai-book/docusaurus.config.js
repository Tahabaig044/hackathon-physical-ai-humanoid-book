  ...
  presets: [
    [
      ...
      ({
        ...
        theme: {
          customCss: ['./src/css/custom.css', './src/styles/custom.css'],
        },
      }),
    ],
  ],
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                docId: 'module-0-introduction/index',
              },
              {
                type: 'doc',
                label: 'Module 1: ROS 2',
                docId: 'module1-ros2/introduction',
              },
              {
                type: 'doc',
                label: 'Module 2: Gazebo & Unity',
                docId: 'module2-gazebo-unity/introduction',
              },
              {
                type: 'doc',
                label: 'Module 3: NVIDIA Isaac',
                docId: 'module3-nvidia-isaac/introduction',
              },
              {
                type: 'doc',
                label: 'Module 4: Vision-Language-Action',
                docId: 'module4-vla/introduction',
              },
              {
                type: 'doc',
                label: 'Module 5: Ethics & Safety',
                docId: 'module-5-ethics-safety/index',
              },
              {
                type: 'doc',
